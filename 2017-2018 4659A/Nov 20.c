...
#pragma config(Motor,  port2,           LDD,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           LMD,           tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           LLU,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           LLD,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           RLU,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           RLD,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           RMD,           tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           RDD,           tmotorVex393_MC29, openLoop)
