#pragma config(Sensor, dgtl1,  Mogo,           sensorQuadEncoder)
#pragma config(Sensor, dgtl3,  DriveL,         sensorQuadEncoder)
#pragma config(Sensor, dgtl11, DriveR,         sensorQuadEncoder)
...
#pragma config(Motor,  port4,           DriveR3,       tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           DriveL1,       tmotorVex393_MC29, openLoop, reversed)
